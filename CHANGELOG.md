...
- **macOS**: Restored the agent summary strip above the sidebar footer — waiting / running / error dots with counts, dimmed when zero. Clicking a state jumps to the next workspace in that state, cycling on repeated clicks.
