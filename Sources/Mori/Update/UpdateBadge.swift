// MARK: - UpdateBadge
// SwiftUI badge view with progress ring and animated icons.
...
/// - Animated rotating icon for checking state (2.5s cycle)
/// - Static SF Symbol icons for other states
struct UpdateBadge: View {
    ...
    private var badgeContent: some View {
        ...
        case .extracting(let extracting):
            ProgressRingView(progress: extracting.normalizedProgress)
