...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setupCommandPalette(appState: AppState, manager: WorkspaceManager) {
        ...
        keyMonitorActionMap = [
            ...
            "projects.goto1": { [weak self] in self?.workspaceManager?.selectProjectByIndex(1) },
            "projects.goto2": { [weak self] in self?.workspaceManager?.selectProjectByIndex(2) },
            "projects.goto3": { [weak self] in self?.workspaceManager?.selectProjectByIndex(3) },
            "projects.goto4": { [weak self] in self?.workspaceManager?.selectProjectByIndex(4) },
            "projects.goto5": { [weak self] in self?.workspaceManager?.selectProjectByIndex(5) },
            "projects.goto6": { [weak self] in self?.workspaceManager?.selectProjectByIndex(6) },
            "projects.goto7": { [weak self] in self?.workspaceManager?.selectProjectByIndex(7) },
            "projects.goto8": { [weak self] in self?.workspaceManager?.selectProjectByIndex(8) },
            "projects.gotoLast": { [weak self] in self?.workspaceManager?.selectProjectByIndex(9) },
            "tabs.gotoTab1": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(1) },
            "tabs.gotoTab2": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(2) },
            "tabs.gotoTab3": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(3) },
            "tabs.gotoTab4": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(4) },
            "tabs.gotoTab5": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(5) },
            "tabs.gotoTab6": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(6) },
            "tabs.gotoTab7": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(7) },
            "tabs.gotoTab8": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(8) },
            "tabs.gotoLastTab": { [weak self] in self?.workspaceManager?.selectWindowByGlobalIndex(9) },
